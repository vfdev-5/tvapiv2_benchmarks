...
python -u main.py profile_transform --t_name=ScaleJitter --t_args="((1024, 1024), )" &> output/${prefix}_profile_scalejitter.log

# python -u main.py profile_transform --t_name=FixedSizeCrop --t_args="((1024, 1024), )" --t_kwargs="{'fill': 0}" &> output/${prefix}_profile_fixedsizecrop.log
